            ...
            <div class="card">
                ...
                <table class="table table-hover table-sm">
                    ...
                    <?php foreach ($ColeccionIntegrantes->getIntegrantes() as $Integrante) {
                        if(stripos(strtolower($Integrante->getNombres()), $valorBusqueda) !== false){$valor=1?>
                        <tr>
                ...
                <div><?php if($valor=='0') {echo '<h5 align="center" style="color:gray;">No se encontraron integrantes con ese nombre</h5>';}?></div>
            </div>
        </div>
    </div>
