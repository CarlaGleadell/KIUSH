...
$valorBusqueda= $_GET['busquedaPersona'];
$valor='0';
?>
            ...
            <div class="card">
                ...
                <table class="table table-hover table-sm">
                    ...
                    <?php foreach ($ColeccionPersonas->getPersonas() as $Persona) {
                        if(stripos(strtolower($Persona->getNombre()), $valorBusqueda) !== false){$valor=1?>
                        <tr>
                ...
                <div><?php if($valor=='0') {echo '<h5 align="center" style="color:gray;">No se encontraron inscriptos con ese nombre</h5>';}?></div>
            </div>
        </div>
    </div>
